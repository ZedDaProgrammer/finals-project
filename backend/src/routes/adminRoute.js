...
const { getBookings, updateReservationStatus, getTicket, updateTicketStatus, deleteReservation, getComputers, updateComputerStatus } = require('../controller/adminController');
